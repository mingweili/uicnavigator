...
public class MainActivity extends Activity implements
	...
	public boolean onOptionsItemSelected(MenuItem item) {
	    ...
	    switch (item.getItemId()) {
	        case R.id.main_menu_action_show_list:
	            intent.setClass(this, BuildingInventoryActivity.class);
	            startActivity(intent);
	            return true;
	        case R.id.main_menu_action_navigate:
	            intent.setClass(this, NavigationActivity.class);
	            startActivity(intent);
	            return true;
	        case R.id.main_menu_action_satellite_switch:
	        	switchMapType(item);
	        	return true;
	...
	private void switchMapType(MenuItem item) {
		...
		if(this.mMap.getMapType() == GoogleMap.MAP_TYPE_NORMAL) {
			...
			item.setTitle(getString(R.string.main_menu_action_satellite_switch_title_0));
		}
		else {
			this.mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
			item.setTitle(getString(R.string.main_menu_action_satellite_switch_title_1));
		}
	}
